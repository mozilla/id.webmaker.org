...
OAuthDB.prototype.get_client = function(clientId, callback) {
  if (!this.clients[clientId]) {
    return process.nextTick(function() {
      callback(Boom.badRequest('invalid clientId'));
    });
  }
...
OAuthDB.prototype.generate_auth_code = function(clientId, userId, scopes, expiresAt, callback) {
